...
<div class="imagen-perfil">
    ...
    <div class="form_editar">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" method ="post">
            <input type="text" name="nombre" class="form-control mb-1" value="<?php echo $usuario['nombre']; ?>">
            <input type="text" name="correo" class="form-control mb-1" value="<?php echo $usuario['correo']; ?>">
            <input type="text" name="profesion" class="form-control mb-1 " value="<?php echo $usuario['profesion']; ?>">
            <input type="text" name="ciudad" class="form-control mb-1" value="<?php echo $usuario['ciudad']; ?>">
            <input type="file"name="foto" class="form-control mb-1" value="Carga tu foto" style="margin-bottom: 1em;">
